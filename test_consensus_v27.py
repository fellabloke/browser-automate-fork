...
Run: .venv/bin/python -m pytest test_consensus_v27.py -v
"""
...
from consensus import (
    weighted_vote, should_abstain, canonical_action_key,
    distinct_base_model_clients, count_distinct_base_models, sample_ensemble,
)
