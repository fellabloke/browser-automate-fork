...
export TASK="Go to https://github.com/langchain-ai/langgraph/discussions. Figure out how to create a new discussion. Choose an appropriate category (like 'Show and tell' or similar).
Title of the post: Anthropic Fable 5 Review & Agent First IDE Release Update

Body of the post:
$POST_CONTENT

Publish the discussion post by clicking the start discussion or publish button and verify that it has been posted successfully."

.venv/bin/python run_v16.py run "$TASK"
