...
def compute_clarity(decision: dict, state: dict, *,
    ...
    from agent_first_browse.cognition.target_lock.extract_target (optional).
    Pure + deterministic.
    """
    ...
    try:
        from agent_first_browse.cognition.target_lock import (is_primary_action_click, count_lookalikes,
                                 off_target_risk)
